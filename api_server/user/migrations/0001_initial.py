# Generated by Django 3.0.3 on 2020-02-21 10:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.Progress')),
            ],
        ),
        migrations.CreateModel(
            name='WatchType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasks', models.ManyToManyField(to='user.Task')),
